        ...
        <div className="bg-white w-[100%] grid grid-cols-3 3xl:grid-cols-4">
            <div className="text-base flex rounded-xl flex-col justify-evenly font-sans font-normal bg-[#65439a] text-white mx-4 my-4">
                ...
                country. A must-read for everyone interested in higher education
                    and research.<br/></p>
                <span className='flex w-full justify-end font-sans font-medium text-right px-5 pb-2'>
                    ~N. R. Narayana Murthy,<br/>Founder, Infosys
                </span>
            </div>
                <div className="text-base flex rounded-xl flex-col justify-evenly font-sans font-normal bg-[#65439a] text-white mx-4 my-4">
                    <p className='px-5 py-2'>This book describes in depth the fundamental issues in Indian
                ...
                <div className="text-base flex rounded-xl flex-col justify-evenly font-sans font-normal bg-[#65439a] text-white mx-4 my-4">
                    <p className='px-5 pb-2 pt-5'>Higher education in India has grown tremendously. However,
                    ...
                    <span className='flex w-full justify-end font-sans font-medium text-right px-5 pb-5'>
                        ~Professor Anil Sahasrabudhe,<br/>Chairman, AICTE
                    </span>
                </div>
                <div className="text-base flex rounded-xl flex-col justify-evenly font-sans font-normal bg-[#65439a] text-white mx-4 my-4">
                    <p className='px-5 pb-2 pt-5'>The book presents a very comprehensive view of the current
                ...
                <div className="text-base flex rounded-xl flex-col justify-evenly font-sans font-normal bg-[#65439a] text-white mx-4 my-4"><p className='px-5 py-2'>India urgently needs world-class research universities. This book
                ...
                <div className="text-base flex rounded-xl flex-col justify-evenly font-sans font-normal bg-[#65439a] text-white mx-4 my-4">
                    <p className='px-5 py-2'>This book, based on the insights from Pankaj Jalote’s success
                ...
                <div className="text-base flex rounded-xl flex-col justify-evenly font-sans font-normal bg-[#65439a] text-white mx-4 my-4"><p className='px-5 pt-5 pb-2'>Knowledge without action is meaningless. Pankaj embodies this
                ...
                <div className="text-base flex rounded-xl flex-col justify-evenly font-sans font-normal bg-[#65439a] text-white mx-4 my-4"><p className='px-5 py-2'>Higher education in India is huge and complex. Professor Jalote,
                ...
                <div className="text-base flex rounded-xl flex-col justify-evenly font-sans font-normal bg-[#65439a] text-white mx-4 my-4">
                    <p className='px-5 py-2'>IIIT-Delhi has become a world-class institution in a short time
                ...
                <div className="text-base flex rounded-xl flex-col justify-evenly font-sans font-normal bg-[#65439a] text-white mx-4 my-4"><p className='px-5 py-2'>The analysis presented in this book thoughtfully reveals the
                ...
                <div className="text-base flex rounded-xl flex-col justify-evenly font-sans font-normal bg-[#65439a] text-white mx-4 my-4"><p className='px-5 py-2'>This is a comprehensive book that provides a foundation for
                ...
                <div className="text-base flex rounded-xl flex-col justify-evenly font-sans font-normal bg-[#65439a] text-white mx-4 my-4">
                    <p className='px-5 pb-2 pt-5'>Jalote’s argument for improving the research culture and ethics
                ...
                <div className="text-base flex rounded-xl flex-col justify-evenly font-sans font-normal bg-[#65439a] text-white mx-4 my-4">
                    <p className='px-5 py-2'>For thriving in the knowledge-based global economy, India needs
                ...
                <div className="text-base flex rounded-xl flex-col justify-evenly font-sans font-normal bg-[#65439a] text-white mx-4 my-4">
                    <p className='px-5 pb-2 pt-5'>In this powerfully argued book, Pankaj Jalote provides a primer
                ...
                <div className="text-base flex rounded-xl flex-col justify-evenly font-sans font-normal bg-[#65439a] text-white mx-4 my-4">
                    <p className='px-5 py-2'>India needs many more research universities which can reach
                ...
                <div className="text-base flex rounded-xl flex-col justify-evenly font-sans font-normal bg-[#65439a] text-white mx-4 my-4">
                    <p className='px-5 pb-2 pt-5'>Jayant V. Narlikar once stated, ‘Just as a teacher who does not
