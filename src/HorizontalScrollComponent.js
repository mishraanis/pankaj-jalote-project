...
export default function HorizontalScrollComponent(){
    // make the list items scroll horizontally automatically when the page loads
...
and research.<br/>
                <span className='flex w-full justify-end font-sans font-medium text-right'>~N. R. Narayana Murthy,<br/>
Founder, Infosys</span></li>
                <li className="item text-base font-sans font-normal bg-[#65439a] text-white">This book describes in depth the fundamental issues in Indian
...
administrators and policymakers.<br/>
                <span className='flex w-full justify-end font-sans font-medium text-right'>~Professor Sudhir Sopory,<br/>
Former VC, JNU</span>
                </li>
                <li className="item text-base font-sans font-normal bg-[#65439a] text-white">Higher education in India has grown tremendously. However,
...
and students of higher education.<br/>
                <span className='flex w-full justify-end font-sans font-medium text-right'>~Professor Anil Sahasrabudhe,<br/>
Chairman, AICTE</span></li>
                <li className="item text-base font-sans font-normal bg-[#65439a] text-white">The book presents a very comprehensive view of the current
...
research in universities, especially in India.<br/>
                <span className='flex w-full justify-end font-sans font-medium text-right'>~Professor Surendra Prasad,<br/>
Former Director, IIT Delhi</span></li>
...
benefit from this book!<br/>
                <span className='flex w-full justify-end font-sans font-medium text-right'>~Nandan Nilekani,<br/>
Chairman, Infosys</span></li>
                <li className="item text-base font-sans font-normal bg-[#65439a] text-white">This book, based on the insights from Pankaj Jalote’s success
...
knowledge-based economy.<br/>
                <span className='flex w-full justify-end font-sans font-medium text-right'>~T. V. Mohandas Pai,<br/>
Chairman, Manipal Global Education Services</span></li>
...
across the globe.<br/>
                <span className='flex w-full justify-end font-sans font-medium text-right'>~Professor Dinesh Singh,<br/>
Former VC, Delhi University</span></li>
...
our institutions can stay relevant.<br/>
                <span className='flex w-full justify-end font-sans font-medium text-right'>~Professor V. Ramgopal Rao,<br/>
Director, IIT Delhi</span></li>
                <li className="item text-base font-sans font-normal bg-[#65439a] text-white">IIIT-Delhi has become a world-class institution in a short time
...
the vision and borrowing best practices globally.<br/>
                <span className='flex w-full justify-end font-sans font-medium text-right'>~Professor Bijendra Jain,<br/>Former Vice Chancellor, BITS Pilani,<br/>
and Deputy Director, IIT Delhi</span></li>
...
things around.<br/>
                <span className='flex w-full justify-end font-sans font-medium text-right'>~Professor Fazal Rizvi,<br/>
The University of Melbourne, Australia</span></li>
...
in Indian research universities and their future.<br/>
                <span className='flex w-full justify-end font-sans font-medium text-right'>~Professor Satish K. Tripathi,<br/>
President, State University of New York at Buffalo</span></li>
                <li className="item text-base font-sans font-normal bg-[#65439a] text-white">Jalote’s argument for improving the research culture and ethics
...
Listen to him.<br/>
                <span className='flex w-full justify-end font-sans font-medium text-right'>~Professor Pankaj Chandra,<br/>Vice Chancellor, Ahmedabad University,<br/>
Former Director, IIM Bangalore</span></li>
                <li className="item text-base font-sans font-normal bg-[#65439a] text-white">For thriving in the knowledge-based global economy, India needs
...
to develop world-class universities.<br/>
                <span className='flex w-full justify-end font-sans font-medium text-right'>~Professor Ashutosh Sharma,<br/>
Secretary, DST</span></li>
                <li className="item text-base font-sans font-normal bg-[#65439a] text-white">In this powerfully argued book, Pankaj Jalote provides a primer
...
from scratch.<br/>
                <span className='flex w-full justify-end font-sans font-medium text-right'>~Arun Sharma, AM,<br/>Distinguished Professor Emeritus and Former Deputy Vice Chancellor and Vice-President, QUT</span></li>
                <li className="item text-base font-sans font-normal bg-[#65439a] text-white">India needs many more research universities which can reach
...
universities and thinkers.<br/>
                <span className='flex w-full justify-end font-sans font-medium text-right'>~Prof. K. Vijay Raghavan,<br/>
Principal Scientific Adviser to the Government of India</span></li>
                <li className="item text-base font-sans font-normal bg-[#65439a] text-white">Jayant V. Narlikar once stated, ‘Just as a teacher who does not
...
guide and roadmap for translating this idea into action.<br/>
                <span className='flex w-full justify-end font-sans font-medium text-right'>~Furqan Qamar,<br/>
Professor of Management, Jamia Millia Islamia</span></li>
            </ul>
        </div>
    )
}