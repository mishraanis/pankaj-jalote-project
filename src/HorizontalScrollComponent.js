...
export default function HorizontalScrollComponent(){
    return(
        <div className="bg-white w-[100%] grid grid-cols-1 md:grid-cols-3 3xl:grid-cols-4 px-7">
            <div className="text-sm flex rounded-xl flex-col justify-evenly font-sans font-normal bg-[#65439a] text-white mx-4 my-4">
                ...
                <div className="text-sm flex rounded-xl flex-col justify-evenly font-sans font-normal bg-[#65439a] text-white mx-4 my-4"><p className='px-4 py-2'>India urgently needs world-class research universities. This book
                ...
                <div className="text-sm flex rounded-xl flex-col justify-evenly font-sans font-normal bg-[#65439a] text-white mx-4 my-4"><p className='px-4 pt-5 pb-2'>Knowledge without action is meaningless. Pankaj embodies this
                ...
                <div className="text-sm flex rounded-xl flex-col justify-evenly font-sans font-normal bg-[#65439a] text-white mx-4 my-4"><p className='px-4 py-2'>Higher education in India is huge and complex. Professor Jalote,
                ...
                <div className="text-sm flex rounded-xl flex-col justify-evenly font-sans font-normal bg-[#65439a] text-white mx-4 my-4"><p className='px-4 py-2'>The analysis presented in this book thoughtfully reveals the
                ...
                <div className="text-sm flex rounded-xl flex-col justify-evenly font-sans font-normal bg-[#65439a] text-white mx-4 my-4"><p className='px-4 py-2'>This is a comprehensive book that provides a foundation for
