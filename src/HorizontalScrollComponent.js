...
export default function HorizontalScrollComponent(){
    return(
        <div className="bg-white w-[100%] grid grid-cols-1 md:grid-cols-3 3xl:grid-cols-4 px-7">
            <div className="text-sm flex rounded-xl flex-col justify-evenly font-sans font-normal border-[#9e83c9] border-2 bg-white text-black mx-4 my-4">
                <p className='px-4 py-2'>A nation is as strong as its higher educational and research institutions.
                ...
                country. A must-read for everyone interested in higher education
                    and research.<br/></p>
                <span className='flex w-full justify-end font-sans font-medium text-right px-4 pb-2'>
                    ~N. R. Narayana Murthy,<br/>Founder, Infosys
                </span>
            </div>
                <div className="text-sm flex rounded-xl flex-col justify-evenly font-sans font-normal border-[#9e83c9] border-2 bg-white text-black mx-4 my-4">
                    <p className='px-4 py-2'>This book describes in depth the fundamental issues in Indian
                    ...
                    involved with the governance of higher education, especially the
                        administrators and policymakers.<br/></p>
                    <span className='flex w-full justify-end font-sans font-medium text-right px-4 pb-2'>
                        ~Professor Sudhir Sopory,<br/>Former VC, JNU
                    </span>
                </div>
                <div className="text-sm flex rounded-xl flex-col justify-evenly font-sans font-normal border-[#9e83c9] border-2 bg-white text-black mx-4 my-4">
                    <p className='px-4 pb-2 pt-5'>Higher education in India has grown tremendously. However,
                    ...
                    open new vistas for policymakers, educationists, administrators
                        and students of higher education.<br/></p>
                    <span className='flex w-full justify-end font-sans font-medium text-right px-4 pb-5'>
                        ~Professor Anil Sahasrabudhe,<br/>Chairman, AICTE
                    </span>
                </div>
                <div className="text-sm flex rounded-xl flex-col justify-evenly font-sans font-normal border-[#9e83c9] border-2 bg-white text-black mx-4 my-4">
                    <p className='px-4 pb-2 pt-5'>The book presents a very comprehensive view of the current
                    ...
                    who are seriously interested in promoting high-end academic
                        research in universities, especially in India.<br/></p>
                    <span className='flex w-full justify-end font-sans font-medium text-right px-4 pb-5'>
                        ~Professor Surendra Prasad,<br/>Former Director, IIT Delhi
                    </span>
                </div>
                <div className="text-sm flex rounded-xl flex-col justify-evenly font-sans font-normal border-[#9e83c9] border-2 bg-white text-black mx-4 my-4"><p className='px-4 py-2'>India urgently needs world-class research universities. This book
                    ...
                    benefit from this book!<br/></p>
                    <span className='flex w-full justify-end font-sans font-medium text-right px-4 pb-2'>
                        ~Nandan Nilekani,<br/>Chairman, Infosys
                    </span>
                </div>
                <div className="text-sm flex rounded-xl flex-col justify-evenly font-sans font-normal border-[#9e83c9] border-2 bg-white text-black mx-4 my-4">
                    <p className='px-4 py-2'>This book, based on the insights from Pankaj Jalote’s success
                    ...
                    which is innovative and cutting-edge as new India grows into a
                        knowledge-based economy.<br/></p>
                    <span className='flex w-full justify-end font-sans font-medium text-right px-4 pb-2'>
                        ~T. V. Mohandas Pai,<br/>Chairman, Manipal Global Education Services
                    </span>
                </div>
                <div className="text-sm flex rounded-xl flex-col justify-evenly font-sans font-normal border-[#9e83c9] border-2 bg-white text-black mx-4 my-4"><p className='px-4 pt-5 pb-2'>Knowledge without action is meaningless. Pankaj embodies this
                ...
                <div className="text-sm flex rounded-xl flex-col justify-evenly font-sans font-normal border-[#9e83c9] border-2 bg-white text-black mx-4 my-4"><p className='px-4 py-2'>Higher education in India is huge and complex. Professor Jalote,
                    ...
                    our institutions can stay relevant.<br/></p>
                    <span className='flex w-full justify-end font-sans font-medium text-right px-4 pb-2'>
                        ~Professor V. Ramgopal Rao,<br/>Director, IIT Delhi
                    </span>
                </div>
                <div className="text-sm flex rounded-xl flex-col justify-evenly font-sans font-normal border-[#9e83c9] border-2 bg-white text-black mx-4 my-4">
                    <p className='px-4 py-2'>IIIT-Delhi has become a world-class institution in a short time
                    ...
                    what it takes to build an institution while remaining focused on
                        the vision and borrowing best practices globally.<br/></p>
                    <span className='flex w-full justify-end font-sans font-medium text-right px-4 pb-2'>
                        ~Professor Bijendra Jain,<br/>Former Vice Chancellor, BITS Pilani,<br/>and Deputy Director, IIT Delhi
                    </span>
                </div>
                <div className="text-sm flex rounded-xl flex-col justify-evenly font-sans font-normal border-[#9e83c9] border-2 bg-white text-black mx-4 my-4"><p className='px-4 py-2'>The analysis presented in this book thoughtfully reveals the
                ...
                <div className="text-sm flex rounded-xl flex-col justify-evenly font-sans font-normal border-[#9e83c9] border-2 bg-white text-black mx-4 my-4"><p className='px-4 py-2'>This is a comprehensive book that provides a foundation for
                    ...
                    in Indian research universities and their future.<br/></p>
                    <span className='flex w-full justify-end font-sans font-medium text-right px-4 pb-2'>
                        ~Professor Satish K. Tripathi,<br/>President, State University of New York at Buffalo
                    </span>
                </div>
                <div className="text-sm flex rounded-xl flex-col justify-evenly font-sans font-normal border-[#9e83c9] border-2 bg-white text-black mx-4 my-4">
                    <p className='px-4 pb-2 pt-5'>Jalote’s argument for improving the research culture and ethics
                ...
                <div className="text-sm flex rounded-xl flex-col justify-evenly font-sans font-normal border-[#9e83c9] border-2 bg-white text-black mx-4 my-4">
                    <p className='px-4 py-2'>For thriving in the knowledge-based global economy, India needs
                    ...
                    and implementing the structures and processes required
                        to develop world-class universities.<br/></p>
                    <span className='flex w-full justify-end font-sans font-medium text-right px-4 pb-2'>
                        ~Professor Ashutosh Sharma,<br/>Secretary, DST
                    </span>
                </div>
                <div className="text-sm flex rounded-xl flex-col justify-evenly font-sans font-normal border-[#9e83c9] border-2 bg-white text-black mx-4 my-4">
                    <p className='px-4 pb-2 pt-5'>In this powerfully argued book, Pankaj Jalote provides a primer
                ...
                <div className="text-sm flex rounded-xl flex-col justify-evenly font-sans font-normal border-[#9e83c9] border-2 bg-white text-black mx-4 my-4">
                    <p className='px-4 py-2'>India needs many more research universities which can reach
                    ...
                    welcome book on an important topic which will be useful for all
                        universities and thinkers.<br/></p>
                    <span className='flex w-full justify-end font-sans font-medium text-right px-4 pb-2'>
                        ~Prof. K. Vijay Raghavan,<br/>Principal Scientific Adviser to the Government of India
                    </span>
                </div>
                <div className="text-sm flex rounded-xl flex-col justify-evenly font-sans font-normal border-[#9e83c9] border-2 bg-white text-black mx-4 my-4">
                    <p className='px-4 pb-2 pt-5'>Jayant V. Narlikar once stated, ‘Just as a teacher who does not
                    ...
                    teaching and research. Pankaj Jalote’s book serves as a practical
                        guide and roadmap for translating this idea into action.<br/></p>
                    <span className='flex w-full justify-end font-sans font-medium text-right px-4 pb-5'>
