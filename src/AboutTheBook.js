...
export default function AboutTheBook() {
    return (
        <div id="about-the-book" className='flex flex-col w-full items-center'>
            <div className=' flex flex-col items-center md:flex-row md:justify-center w-full pt-40 lg:pt-24 3xl:pt-40'>
                <div className='w-8/12 md:w-8/12 pb-6 md:pb-0 flex flex-col flex-col-reverse md:flex-row items-center justify-center md:px-0'>
                    ...
                    <img src={frontPage} className=' w-[100%] mb-10 md:mb-0 md:w-[35%] border-[0.1rem] border-neutral-900' alt='book-front-cover'/>
                </div>
            </div>
        </div>
    )
