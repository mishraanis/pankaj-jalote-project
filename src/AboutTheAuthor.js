    ...
    return(
        <div className='w-full flex flex-col justify-center items-center pb-20 pt-12'>
            ...
            <div className='w-full flex justify-evenly 3xl:w-10/12 items-center font-sans font-semibold'>
                ...
                <div className='w-9/12 md:w-7/12 text-base md:text-base 3xl:text-xl'>
                    <span className='text-xl text-violet-800'>Pankaj Jalote</span> was the founding Director of IIIT-Delhi (from 2008 to 2018),
